...
public:
	...
	~Chess_Util();
	static QHash<int, QPair<GameRecord, int> > chessTypeInfo;//存储棋形以及对应的分数 截断位置
	static QHash<GameRecord, int> chessTypeValue;//记录每种棋形value
	static QHash<Info, int> StartInfo;//存储开局信息 先手 五手N打 开局三子
